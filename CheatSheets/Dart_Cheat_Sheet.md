# dart-cheat-sheet
A list of awesome stuff needed to get started with your flutter development journey
...
###  Example
 ...
 ```dart
    String fullName(){
        ...
        String lastName = "Adee";
        return '$firstName $lastName'; // returns 'James Adee'
    }
 ```
...
final email = "xyz@gmail.com"; // you can't change the value
final String email = "abc@gmail.com"; // you can't change the value
